...
namespace Hypo_Banka
{
    public class Kredit
    {
        ...
        {
            return "Kredit koji se treba vratiti najkasnije na dan " + RokOtplate.Day.ToString() + "." + RokOtplate.Month.ToString()
                + "." + RokOtplate.Year.ToString() + ". godine ima preostali iznos od " + iznos.ToString() + " KM. Iznos rate je "
                + Rata.ToString() + " KM, po stopi od " + KamatnaStopa * 100 + " %.";
        }
