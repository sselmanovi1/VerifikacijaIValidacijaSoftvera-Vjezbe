...
namespace Lovid20.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            foreach (var admin in _context.Administrator)
                if (admin.id == id)
                    administratorDB = admin;

            administratorDB = await _context.Administrator.FindAsync(id);
            if (administratorDB == null)
            {
                return NotFound();
            }
        ...
        /* This method returns _context.Administrator */
